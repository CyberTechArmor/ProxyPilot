...
export function baoFixture(db,{initialized=false,sealed=true}={}){const resources=new Map(),policies=new Map(),mounts={},auth={},calls=[],tokens=new Set(),secretIds=new Map(),unsealKeys=[],initBodies=[];let unavailable=false,progress=0,initCount=0,cluster='g6-cluster',broad=false,revocations=0;
