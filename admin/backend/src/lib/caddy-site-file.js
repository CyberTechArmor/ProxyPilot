...
export const CADDY_SITE_RENDER_CONTRACT = '6'; // 3: allowlist refusals carry DENIED_BODY; 4: allowlist may apply to named paths only; 5: the refusal is an HTML page; 6: a neutral page
...
// The body of an allowlist refusal: a neutral, self-contained page (no
// external assets, light/dark, phone-sized). It deliberately names nothing
// about how access is granted (no VPN, network, DNS or product detail); the
// visitor's own address is shown only as a support reference. No double
// quotes or backslashes, so it embeds unchanged as a Caddyfile string.
export const DENIED_BODY = '<!doctype html><html lang=\'en\'><head><meta charset=\'utf-8\'><meta name=\'viewport\' content=\'width=device-width,initial-scale=1\'><meta name=\'robots\' content=\'noindex,nofollow\'><title>Access restricted</title><style>:root{color-scheme:light dark;--bg:#f5f7fa;--card:#ffffff;--fg:#111827;--muted:#6b7280;--line:#e5e7eb;--icon:#374151;--iconbg:#f3f4f6}@media (prefers-color-scheme:dark){:root{--bg:#0f1115;--card:#171a21;--fg:#f3f4f6;--muted:#9ca3af;--line:#262a33;--icon:#d1d5db;--iconbg:#1f232b}}*{box-sizing:border-box}html,body{height:100%}body{margin:0;display:flex;align-items:center;justify-content:center;padding:24px 16px;background:var(--bg);color:var(--fg);font:15px/1.6 Inter,system-ui,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased}main{width:100%;max-width:440px;background:var(--card);border:1px solid var(--line);border-radius:12px;padding:40px 32px;text-align:center;box-shadow:0 1px 2px rgba(0,0,0,.04),0 8px 24px rgba(0,0,0,.06)}.icon{width:56px;height:56px;margin:0 auto 20px;border-radius:50%;background:var(--iconbg);display:flex;align-items:center;justify-content:center;color:var(--icon)}h1{font-size:20px;font-weight:600;letter-spacing:-.01em;margin:0 0 8px}p{margin:0;color:var(--muted)}.ref{margin-top:28px;padding-top:16px;border-top:1px solid var(--line);font-size:12px;color:var(--muted);display:flex;justify-content:center;flex-wrap:wrap;gap:4px 16px}.ref span{white-space:nowrap}.ref b{font-weight:500;color:var(--fg)}</style></head><body><main><div class=\'icon\'><svg width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.8\' stroke-linecap=\'round\' stroke-linejoin=\'round\' aria-hidden=\'true\'><rect x=\'4\' y=\'11\' width=\'16\' height=\'10\' rx=\'2\'/><path d=\'M8 11V7a4 4 0 0 1 8 0v4\'/></svg></div><h1>Access restricted</h1><p>This site is available only from authorized networks. If you believe you should have access, please contact your administrator.</p><div class=\'ref\'><span>Error <b>403</b></span><span>Host <b>{http.request.host}</b></span><span>Your address <b>{remote_host}</b></span></div></main></body></html>';
