...
export const MCP_EXT_INSTRUCTIONS = [
  ...
  'manage_platform_service, reset_platform_setup): one path, stages A→E (A domains/networks, B Keycloak + administrator,',
  'C Pomerium, D Infisical/OpenBao/Vaultwarden, E activate SSO); apply/continue advance ONE stage. get_platform_setup returns next_actions for the current stage — follow the mcp ones and',
