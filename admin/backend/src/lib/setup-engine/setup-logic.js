...
export const BACKEND_STEP_KINDS = Object.freeze(['configure_vaultwarden_route', 'remove_platform_routes', 'update_platform_networks', 'configure_openbao_route', 'configure_infisical_route', 'configure_pomerium_routes', 'configure_routes', 'configure_keycloak_route', 'verify_sso', 'configure_recovery_route']);
