...
export const HARNESS_STEPS = Object.freeze([
  {
    ...
    defaults: { model: null, effort: null, thinking: 'adaptive', budgetNote: '16k out' }, tunable: true,
  },
  {
    ...
    defaults: { model: 'claude-fable-5', effort: 'high (deep) / low (iteration)', thinking: 'adaptive (deep) / off', budgetNote: '40–64k dynamic' }, tunable: true,
  },
  {
    ...
    defaults: { model: 'claude-fable-5', effort: 'low', thinking: 'off', budgetNote: '6k out' }, tunable: true,
  },
  {
    ...
    slotKey: 'mockup', laneKey: null, envModelVar: 'MOCK2_MOCKUP_MODEL', envEffortVar: null,
    defaults: { model: 'claude-fable-5', effort: 'high', thinking: 'adaptive', budgetNote: '20k out' }, tunable: true,
  },
  {
    ...
    slotKey: 'mockup', laneKey: null, envModelVar: 'MOCK2_MOCKUP_MODEL', envEffortVar: null,
    defaults: { model: null, effort: 'low', thinking: 'off', budgetNote: '30k × ≤2 hops' }, tunable: true,
  },
  {
    ...
    slotKey: 'concept_chat', laneKey: 'chat', envModelVar: null, envEffortVar: null,
    defaults: { model: null, effort: null, thinking: 'adaptive', budgetNote: '4k out' }, tunable: true,
  },
  {
    ...
    defaults: { model: null, effort: null, thinking: 'off', budgetNote: '32k out, 1 retry' }, tunable: true,
  },
  {
    ...
    slotKey: 'concept_chat', laneKey: null, envModelVar: null, envEffortVar: null,
    defaults: { model: null, effort: null, thinking: 'off', budgetNote: '8k out' }, tunable: true,
  },
  {
    ...
    defaults: { model: null, effort: 'medium', thinking: 'adaptive', budgetNote: '16k out' }, tunable: true,
  },
  {
    ...
    defaults: { model: 'claude-haiku-4-5-20251001', effort: 'low', thinking: 'off', budgetNote: '900 out, 9s timeout' }, tunable: true,
  },
  {
    ...
    slotKey: null, laneKey: null, envModelVar: 'MOCK2_PREPASS_MODEL', envEffortVar: null,
    defaults: { model: 'claude-haiku-4-5-20251001', effort: 'low', thinking: 'off', budgetNote: '900 out' }, tunable: true,
  },
  {
    ...
    slotKey: null, laneKey: null, envModelVar: 'MOCK2_PREPASS_MODEL', envEffortVar: null,
    defaults: { model: 'claude-haiku-4-5-20251001', effort: 'low', thinking: 'off', budgetNote: '1.6k out, 25s timeout' }, tunable: true,
  },
  {
    ...
    defaults: { model: null, effort: 'high (routed)', thinking: 'adaptive', budgetNote: '64k/turn (MOCK2_RUNNER_MAX_TOKENS)' }, tunable: true,
  },
  {
    ...
    defaults: { model: 'claude-fable-5', effort: null, thinking: 'adaptive', budgetNote: '16k out' }, tunable: false,
  },
  {
  ...
  },
  {
    ...
    defaults: { model: 'claude-haiku-4-5-20251001', effort: 'low', thinking: 'off', budgetNote: '0.9k out' }, tunable: true,
  },
  {
    ...
    defaults: { model: null, effort: 'high', thinking: 'adaptive', budgetNote: '2.5k out, 240s timeout' }, tunable: true,
  },
  {
    ...
    defaults: { model: null, effort: null, thinking: 'adaptive', budgetNote: '16k/turn × ≤15 turns' }, tunable: true,
  },
]);
