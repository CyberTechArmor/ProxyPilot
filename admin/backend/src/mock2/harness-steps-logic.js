...
export const HARNESS_STEPS = Object.freeze([
  {
    ...
    defaults: { model: null, effort: null, thinking: 'adaptive', budgetNote: 'uncapped (model max)' }, tunable: true,
  },
  {
  ...
  },
  {
    ...
    slotKey: 'mockup', laneKey: null, envModelVar: 'MOCK2_MOCKUP_MODEL', envEffortVar: null,
    defaults: { model: null, effort: 'low', thinking: 'off', budgetNote: 'uncapped (model max) × ≤2 hops' }, tunable: true,
  },
  {
  ...
  },
  {
    ...
    defaults: { model: null, effort: null, thinking: 'off', budgetNote: 'uncapped (model max), 1 retry' }, tunable: true,
  },
  {
    ...
    slotKey: 'concept_chat', laneKey: null, envModelVar: null, envEffortVar: null,
    defaults: { model: null, effort: null, thinking: 'off', budgetNote: 'uncapped (model max)' }, tunable: true,
  },
  {
    ...
    defaults: { model: null, effort: 'medium', thinking: 'adaptive', budgetNote: 'uncapped (model max)' }, tunable: true,
  },
  {
    ...
    defaults: { model: 'claude-haiku-4-5-20251001', effort: 'low', thinking: 'off', budgetNote: 'uncapped (model max), 9s race' }, tunable: true,
  },
  {
    ...
    slotKey: null, laneKey: null, envModelVar: 'MOCK2_PREPASS_MODEL', envEffortVar: null,
    defaults: { model: 'claude-haiku-4-5-20251001', effort: 'low', thinking: 'off', budgetNote: 'uncapped (model max)' }, tunable: true,
  },
  {
    ...
    slotKey: null, laneKey: null, envModelVar: 'MOCK2_PREPASS_MODEL', envEffortVar: null,
    defaults: { model: 'claude-haiku-4-5-20251001', effort: 'low', thinking: 'off', budgetNote: 'uncapped (model max), 25s race' }, tunable: true,
  },
  {
  ...
  },
  {
    ...
    defaults: { model: null, effort: null, thinking: 'adaptive', budgetNote: 'uncapped/turn × ≤15 turns' }, tunable: true,
  },
]);
