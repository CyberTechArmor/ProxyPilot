    ...
    <div className="space-y-3">
      {connectors.length === 0 ? (
        <p className="text-sm text-muted-foreground">
          No git connector yet. <Link to="/projects/connectors" className="underline">Add a Gitea or GitHub connector</Link> (URL + token) under Dev Studio → Connectors, then come back here.
        </p>
      ) : (
        <>
