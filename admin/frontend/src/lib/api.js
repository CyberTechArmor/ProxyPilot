...
export const api = {
  ...
  getVaultwardenSetup: () => request('/setup/platform/vaultwarden'),
  saveVaultwardenSetup: body => request('/setup/platform/vaultwarden', {method:'PUT',body:JSON.stringify(body)}),
  applyVaultwardenSetup: body => request('/setup/platform/vaultwarden/apply', {method:'POST',body:JSON.stringify(body)}),
  recordVaultwardenCeremony: body => request('/setup/platform/vaultwarden/ceremony', {method:'POST',body:JSON.stringify(body)}),
  getOpenBaoSetup: () => request('/setup/platform/openbao'),
  ...
  linkInfisicalAgentContainer: (name, container) => request(`/setup/platform/infisical/agents/${encodeURIComponent(name)}/container`, { method: 'POST', body: JSON.stringify({ container }) }),
  unlinkInfisicalAgentContainer: (name) => request(`/setup/platform/infisical/agents/${encodeURIComponent(name)}/container/remove`, { method: 'POST', body: '{}' }),
  ...
  applyInfisicalSetup: (body) => request('/setup/platform/infisical/apply', { method: 'POST', body: JSON.stringify(body) }),
  getPomeriumSetup: () => request('/setup/platform/pomerium'),
  savePomeriumSetup: (body) => request('/setup/platform/pomerium', { method: 'PUT', body: JSON.stringify(body) }),
  applyPomeriumSetup: (body) => request('/setup/platform/pomerium/apply', { method: 'POST', body: JSON.stringify(body) }),
  reviewPomeriumRoute: (body) => request('/setup/platform/pomerium/routes/review', { method: 'POST', body: JSON.stringify(body) }),
  applyPomeriumRoute: (body) => request('/setup/platform/pomerium/routes/apply', { method: 'POST', body: JSON.stringify(body) }),
  ...
  getFullPlatform: () => request('/setup/platform/full'),
  reviewFullPlatform: (config) => request('/setup/platform/full/review', { method: 'POST', body: JSON.stringify(config) }),
  saveFullPlatform: (body) => request('/setup/platform/full', { method: 'PUT', body: JSON.stringify(body) }),
  applyFullPlatform: (body) => request('/setup/platform/full/apply', { method: 'POST', body: JSON.stringify(body) }),
  fullPlatformLifecycleReview: (body) => request('/setup/platform/full/lifecycle/review', { method: 'POST', body: JSON.stringify(body) }),
  fullPlatformLifecycle: (body) => request('/setup/platform/full/lifecycle', { method: 'POST', body: JSON.stringify(body) }),
  ...
  getPlatformMcpFlag: () => request('/setup/platform/overview/flag'),
  setPlatformMcpFlag: (enabled) => request('/setup/platform/overview/flag', { method: 'PUT', body: JSON.stringify({ enabled }) }),
  getPlatformService: (service, refresh = false) => request(`/setup/platform/overview/services/${encodeURIComponent(service)}${refresh ? '?refresh=1' : ''}`),
  getPlatformServiceLogs: (service, lines = 50, container = '') => request(`/setup/platform/overview/services/${encodeURIComponent(service)}/logs?lines=${lines}${container ? `&container=${encodeURIComponent(container)}` : ''}`),
  platformServicePreflight: (service) => request(`/setup/platform/overview/services/${encodeURIComponent(service)}/preflight`, { method: 'POST', body: '{}' }),
  platformServiceVerify: (service) => request(`/setup/platform/overview/services/${encodeURIComponent(service)}/verify`, { method: 'POST', body: '{}' }),
  platformServiceRetry: (service) => request(`/setup/platform/overview/services/${encodeURIComponent(service)}/retry`, { method: 'POST', body: '{}' }),
  platformContainerReview: (service, body) => request(`/setup/platform/overview/services/${encodeURIComponent(service)}/containers/review`, { method: 'POST', body: JSON.stringify(body) }),
  platformContainerControl: (service, body) => request(`/setup/platform/overview/services/${encodeURIComponent(service)}/containers`, { method: 'POST', body: JSON.stringify(body) }),
  platformNetworksReview: (additionalNetworks) => request('/setup/platform/overview/networks/review', { method: 'POST', body: JSON.stringify({ additionalNetworks }) }),
  platformNetworksChange: (body) => request('/setup/platform/overview/networks', { method: 'POST', body: JSON.stringify(body) }),
  platformVpnDns: () => request('/setup/platform/overview/vpn-dns'),
  platformVpnDnsSave: (extra) => request('/setup/platform/overview/vpn-dns', { method: 'PUT', body: JSON.stringify({ extra }) }),
  platformResyncReview: () => request('/setup/platform/overview/resync/review', { method: 'POST', body: '{}' }),
  platformResync: (revision) => request('/setup/platform/overview/resync', { method: 'POST', body: JSON.stringify({ revision }) }),
  keycloakRecoveryReview: () => request('/setup/platform/overview/keycloak/recover/review', { method: 'POST', body: '{}' }),
  keycloakRecover: (body) => request('/setup/platform/overview/keycloak/recover', { method: 'POST', body: JSON.stringify(body) }),
