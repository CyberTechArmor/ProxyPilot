        ...
        <TabsContent value="controls" className="mt-4 space-y-6">
          {stepsDoc == null ? (
            ...
            <Card><CardContent className="p-6 text-sm text-muted-foreground">
              The harness steps could not be loaded. Check that this host has the Dev Studio module enabled and that you are an admin.
            </CardContent></Card>
          ) : (
            <>
              <p className="text-xs text-muted-foreground">
          ...
          {doc == null ? (
            ...
            <Card>
              <CardContent className="p-6 text-sm text-muted-foreground">
                The harness guide could not be loaded. Check that this host has the Dev Studio module enabled and that you are an admin.
              </CardContent>
            </Card>
          ) : (
            <Card>
