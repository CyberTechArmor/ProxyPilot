...
import GitRemoteCard from '@/components/mock2/GitRemoteCard';
      ...
      <CardContent className="space-y-4">
        ...
        {isAdmin ? (
          <GitRemoteCard
            ...
            description="Optional. Push the bare repo to Gitea or GitHub — after every checkpoint, or only when you press Push now. The repository can be created on the remote for you."
          />
        ) : null}
      </CardContent>
    </Card>
