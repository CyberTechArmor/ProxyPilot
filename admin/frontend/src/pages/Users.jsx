...
function AiUsageDialog({ user, open, onOpenChange }) {
  ...
  useEffect(() => {
    ...
    api.mock2UserAiUsage(user.id)
      ...
      .catch((e) => setErr(e?.message || 'Could not load AI usage (is the Dev Studio module enabled on this host?)'));
  }, [open, user]);
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  ...
                  <div className="flex items-center justify-between gap-3 p-3 border rounded-lg">
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Dev Studio page (dev/build module)
                      </p>
                    </div>
                    <Switch
                      id="perm-developer"
              ...
              {accessTab === 'projects' && userProjects ? (
                <div className="space-y-2 max-h-80 overflow-auto">
                  ...
                  <p className="text-xs text-muted-foreground pt-1">
                    ...
                    feature permission above controls whether the Dev Studio page shows at all.
                  </p>
                </div>
              ) : accessTab === 'services' ? (
                <div className="space-y-2 max-h-80 overflow-auto">
