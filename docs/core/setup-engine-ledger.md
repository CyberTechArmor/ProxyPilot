...
**Milestone A estimate: ≈ 85 %, held** (the lifecycle slice's first review
found four defects in its own requirements, R-023…R-026, fixed on the same
branch; the ≈ 88 % proposal stands for the re-review — the platform ledger
carries the basis: A-17 is about ten points over nine groups and this first
group is about three of them). What keeps the milestone short of complete: A-16 (the MCP
...
## Overall new-platform repository work: ≈ 38 %, held (≈ 39 % proposed on acceptance of the lifecycle slice)

Basis for the proposed increase: milestone A would move three points and is
