...
| `mobile-overflow` | mvp | 🔒 | Make it fit (escape hatch: `overflow:hidden` hides content — known, unfixed, noted). **Sound enough** — kept untouched. |
